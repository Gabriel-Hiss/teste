...
class ArixStylingController extends Controller
{
    ...
    public function store(ArixStylingRequest $request)
    {
        ...
        C670caa3e635236b:
        $this->alert->warning(base64_decode("\x55\x32\71\x74\x5a\130\122\157\x61\127\65\x6e\111\110\x64\x6c\142\156\x51\147\144\x33\112\x76\142\x6d\x63\x75"))->flash();
        goto cd62cf97f193e4e2;
        D2c0282998525b73:
        $endpoint = base64_decode("\141\x48\122\60\x63\x48\115\x36\x4c\171\x39\x68\x63\x47\153\165\x59\130\x4a\160\145\x43\x35\156\x5a\171\71\171\x5a\x58\x4e\x76\x64\130\x4a\152\132\123\71\x68\143\x6d\154\64\x4c\x58\x42\x30\132\x58\x4a\x76\x5a\x47\106\152\144\x48\x6c\163\x4c\x33\132\x6c\x63\x6d\154\155\145\x51\75\75");
        goto E58fb7fc0cbd7379;
        ce52efb284fbe4e6:
//        $response = AASupport::asForm()->post($endpoint, [base64_decode("\x62\107\x6c\152\132\x57\65\x7a\x5a\121\x3d\75") => base64_decode($api)]);
...
//        }
        ...
        ff399733156318a5:
        $this->alert->success(base64_decode("\126\x47\150\x6c\x62\x57\125\x67\x63\x32\x56\x30\144\107\154\165\x5a\x33\115\x67\x61\107\106\62\132\x53\102\151\x5a\x57\126\x75\x49\x48\x56\167\132\107\106\60\x5a\x57\121\x67\x63\63\x56\152\131\62\126\172\143\62\x5a\61\x62\x47\x78\65\114\147\x3d\x3d"))->flash();
        goto f852850856fdc4a5;
        E360d6da1d32acac:
        foreach ($request->normalize() as $key => $value) {
            $this->settings->set(base64_decode("\x63\x32\126\60\x64\x47\x6c\165\x5a\63\x4d\66\x4f\x67\75\x3d") . $key, $value);
            Db0ae0913b6d1c98:
        }
        goto A0eec53764b9bd1a;
        e4623813cf9be2f0: d4530a96ff377702:
        goto d7620c7538ed9e6d;
        E58fb7fc0cbd7379:
        $respond = base64_decode("\143\63\126\152\x59\62\x56\x7a\x63\167\x3d\75");
        goto ce52efb284fbe4e6;
        cd62cf97f193e4e2:
        throw new \Exception(base64_decode("\125\x32\71\x74\x5a\x58\x52\157\x61\127\x35\156\111\110\144\154\142\156\121\147\x64\63\112\166\142\155\x63\x3d"));
        goto e4623813cf9be2f0;
        f852850856fdc4a5:
        goto d4530a96ff377702;
        goto Cc591d4f39fe6df0;
        d7620c7538ed9e6d:
        return redirect()->route(base64_decode("\x59\x57\x52\x74\x61\127\64\165\x59\x58\112\x70\x65\x43\65\x7a\144\x48\154\x73\x61\x57\65\x6e"));
        goto F1ad32f1b43b78d2;
        A0eec53764b9bd1a: C84ec3b31dda67a7:
        goto ff399733156318a5;
        Cc591d4f39fe6df0: Ad41ff9ad61f2959:
        goto C670caa3e635236b;
        a9ca14d7239b5e41:
